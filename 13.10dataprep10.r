...
createDateData10 = function(path) {
  ...
  as_tibble() %>%
  filter(climateSum > 0) %>% 
  filter(dok_datum >= lubridate::as_date("2010-10-04") & dok_datum <= lubridate::as_date("2021-07-31")) %>%
...
data = createDateData10(path)
dataParagraph10 = createData(data)
save(dataParagraph10, file='/home/petter/data/ThesisCode/Topic Model/RData10/dataParagraph10.Rdata')

path = "/home/petter/data/ThesisCode/FeatherCode/FeatherData/dataParagraph.csv"
dataFull = createDateDataFull10(path)
dataParagraphFull10 = createData(dataFull)
save(dataParagraph10, file='/home/petter/data/ThesisCode/Topic Model/RData10/dataParagraph10.Rdata')